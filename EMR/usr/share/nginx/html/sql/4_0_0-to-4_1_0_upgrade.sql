...
#IfNotTable isemr_rule_reminder
...
#IfNotRow2D list_options list_id lists option_id isemr_rule_reminder_intervals
...
#IfNotRow2D list_options list_id lists option_id isemr_rule_reminder_methods
...
#IfNotRow2D list_options list_id lists option_id isemr_rule_reminder_due_opt
...
#IfNotRow2D list_options list_id lists option_id isemr_rule_reminder_inactive_opt
...
#IfMissingColumn isemr_postcalendar_events pc_billing_location
ALTER TABLE isemr_postcalendar_events ADD COLUMN pc_billing_location smallint(6);
#EndIf

#IfMissingColumn isemr_postcalendar_categories pc_cattype
ALTER TABLE `isemr_postcalendar_categories` ADD `pc_cattype` INT( 11 ) NOT NULL COMMENT 'Used in grouping categories';

UPDATE `isemr_postcalendar_categories` SET `pc_cattype`='1' WHERE `pc_catid`='4';
UPDATE `isemr_postcalendar_categories` SET `pc_cattype`='1' WHERE `pc_catid`='2';
UPDATE `isemr_postcalendar_categories` SET `pc_cattype`='1' WHERE `pc_catid`='3';
UPDATE `isemr_postcalendar_categories` SET `pc_cattype`='1' WHERE `pc_catid`='8';
UPDATE `isemr_postcalendar_categories` SET `pc_cattype`='1' WHERE `pc_catid`='11';
#EndIf
...
#IfMissingColumn isemr_postcalendar_events pc_sendalertsms
ALTER TABLE isemr_postcalendar_events ADD pc_sendalertsms VARCHAR(3) NOT NULL DEFAULT 'NO';
#EndIf

#IfMissingColumn isemr_postcalendar_events pc_sendalertemail
ALTER TABLE isemr_postcalendar_events ADD pc_sendalertemail VARCHAR(3) NOT NULL DEFAULT 'NO';
#EndIf
