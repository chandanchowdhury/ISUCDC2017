...
ALTER TABLE isemr_postcalendar_events CHANGE pc_apptstatus pc_apptstatus varchar(15) NOT NULL;
...
CREATE TABLE player_event (
  `pid`             int(11) NOT NULL COMMENT 'references patient_data.pid',
  `date`            date        NOT NULL,
  `pc_eid`          int(11) NOT NULL COMMENT 'references isemr_postcalendar_events.pc_eid',
