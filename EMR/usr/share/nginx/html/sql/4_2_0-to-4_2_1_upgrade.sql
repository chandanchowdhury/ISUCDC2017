...
#IfMissingColumn isemr_postcalendar_events pc_room
ALTER TABLE `isemr_postcalendar_events` ADD `pc_room` varchar(20) NOT NULL DEFAULT '' ;
#EndIf
...
#IfNotRow isemr_rule_reminder id rule_socsec_entry
...
#IfNotRow isemr_rule_reminder id rule_penicillin_allergy
