...
INSERT INTO `isemr_postcalendar_categories` (pc_catid,pc_catname,pc_catcolor,pc_catdesc) VALUES (5, 'Office Visit', '#EEEEEE', 'Normal Office Visit');
INSERT INTO `isemr_postcalendar_categories` (pc_catid,pc_catname,pc_catcolor,pc_catdesc) VALUES (4, 'Vacation', '#EFEFEF', 'Reserved for use to define Scheduled Vacation Time');
INSERT INTO `isemr_postcalendar_categories` (pc_catid,pc_catname,pc_catcolor,pc_catdesc) VALUES (1, 'No Show', '#DDDDDD', 'Reserved to define when an event did not occur as specified.');
INSERT INTO `isemr_postcalendar_categories` (pc_catid,pc_catname,pc_catcolor,pc_catdesc) VALUES (2, 'In Office', '#0000FF', 'Reserved to define when a provider may have available appointments after.');
INSERT INTO `isemr_postcalendar_categories` (pc_catid,pc_catname,pc_catcolor,pc_catdesc) VALUES (3, 'Out Of Office', '#99FFFF', 'Reserved to define when a provider may not have available appointments after.');
INSERT INTO `isemr_postcalendar_categories`  (pc_catid,pc_catname,pc_catcolor,pc_catdesc) VALUES (8, 'Lunch', '#FFFF33', 'Lunch');
