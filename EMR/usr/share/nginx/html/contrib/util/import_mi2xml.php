...
=======
          "', authorized = '"    . 0 .
>>>>>>> df6b6e8d41194d7bc425548546ca13d6a55500fc
          "', info = '"          . '' .
          "', federaldrugid = '" . ''.
          "', upin = '"          . '' .
          "', npi  = '"          . ''.
      ...
      $success = update_password($_SESSION['authId'], 0, $passwd, $passwd, $passwd, true, $insertUserSQL, $username, $prov_id);
      if($success)
      {
