...
-- Grant ALL for each table individually
	...
	GRANT ALL ON openemr.isemr_postcalendar_categories to 'openemr'@'localhost';
	GRANT ALL ON openemr.isemr_postcalendar_events to 'openemr'@'localhost';
	...
	GRANT ALL ON openemr.isemr_rule_reminder to 'openemr'@'localhost';
